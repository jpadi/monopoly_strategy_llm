"""Focused unit tests for Dangerous Monopoly Availability Fields output fields."""
...
_parametrize = make_parametrize_decorator("test_dangerous_monopoly_availability_fields")
