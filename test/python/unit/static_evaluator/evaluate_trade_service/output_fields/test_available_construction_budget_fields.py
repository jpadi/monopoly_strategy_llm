"""Focused unit tests for Available Construction Budget Fields output fields."""
...
_parametrize = make_parametrize_decorator("test_available_construction_budget_fields")
